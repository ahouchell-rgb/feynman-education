    ...
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "12px 16px" }}>
      <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 18 }}>
        ...
        <div style={{ display: "flex", gap: 6, overflowX: "auto", WebkitOverflowScrolling: "touch", paddingBottom: 2 }}>
          {["dashboard", "topics", "questions"].map(t => <Pill key={t} on={tab === t} onClick={() => setTab(t)}>{t.charAt(0).toUpperCase() + t.slice(1)}</Pill>)}
        </div>
      </div>
          ...
          {tab === "dashboard" && dash && (
            <div>
              ...
              <div style={{ display: "flex", gap: 8, marginBottom: 12, flexWrap: "wrap" }}>
                <Stat label="Students" value={dash.mems} color={C.pri} />
                <Stat label="Answers" value={dash.tR} color={C.acc} />
