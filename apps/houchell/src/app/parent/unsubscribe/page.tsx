...
const COL = { bg: "#07111f", card: "rgba(255,255,255,0.07)", border: "rgba(255,255,255,0.12)", text: "#f5f7fb", muted: "#9aa8bc", red: "#ff6b8a" };
      ...
      {state === "done" ? (
        ...
        <>
          ...
          <button onClick={confirm} disabled={state === "busy" || !token}
            style={{ background: COL.red, color: "#06101e", border: "none", borderRadius: 8, padding: "10px 20px", fontSize: 14, fontWeight: 600, cursor: token ? "pointer" : "default", opacity: token ? 1 : 0.5 }}>
