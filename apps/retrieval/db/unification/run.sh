...
{ echo "DROP SCHEMA IF EXISTS feynman CASCADE; CREATE SCHEMA feynman;"; \
  pg_dump "$TEACHER" --schema=public --no-owner --no-privileges -Fp \
  | perl -pe 's/\bpublic\./feynman./g; s/CREATE SCHEMA public;/CREATE SCHEMA IF NOT EXISTS feynman;/g; s/\bSCHEMA public\b/SCHEMA feynman/g; s/feynman\.(gen_random_uuid|uuid_generate_v4)/$1/g; s/ab56a97d-b326-434b-bd0f-1a894fb15819/cef87533-7ff1-4f93-bfcf-22feb66f896a/g'; } \
