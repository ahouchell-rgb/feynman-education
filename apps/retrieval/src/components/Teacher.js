...
export function Teacher({ user }) {
  ...
  const printReport = () => {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>${esc(cls.name)} — report</title>
      ...
      <div class="foot">Generated by Houchell Education. Accuracy is over all questions answered; spaced repetition re-tests weak areas automatically.</div>
        ...
        return (
          <Card style={{ padding: 16, marginBottom: 14, background: C.priSoft, borderColor: "rgba(200,54,45,0.25)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 4, gap: 8 }}>
              <div>
                <div style={{ color: C.txt, fontWeight: 700, fontSize: 14 }}>Welcome to Houchell — let's get you set up</div>
