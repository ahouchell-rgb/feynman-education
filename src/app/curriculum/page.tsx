...
function CurriculumContent() {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      // Years/subjects first, and pick the active year off these ALONE — so a
      // later failure (e.g. a transient units fetch) can never blank the page
      // structure or clear the selected year.
      ...
      // Units second. Recoverable on its own without losing the years above.
