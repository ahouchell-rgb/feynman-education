...
/* ─── Theme ─── */
const C = {
  bg: "#f5f4f0", surface: "#ffffff", border: "#e2ddd6", borderStrong: "#b8b4ac",
  text: "#1c1917", muted: "#6b6560", dim: "#a8a29e",
  accent: "#1c1917", accentFg: "#f5f4f0",
  grn: "#065f46", grnS: "rgba(6,95,70,0.08)",
  red: "#991b1b", redS: "rgba(153,27,27,0.08)",
  amb: "#92400e", ambS: "rgba(146,64,14,0.08)",
...
const DISC = {
  biology:   { color: "#065f46", bg: "rgba(6,95,70,0.08)",   label: "Biology" },
  chemistry: { color: "#7c2d12", bg: "rgba(124,45,18,0.08)", label: "Chemistry" },
  physics:   { color: "#1e3a8a", bg: "rgba(30,58,138,0.08)", label: "Physics" },
  combined:  { color: "#4a1d96", bg: "rgba(74,29,150,0.08)", label: "Combined" },
};
