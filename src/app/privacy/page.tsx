...
const SECTIONS: [string, string][] = [
  ...
  ["Contact", "privacy@feynman.education — for data requests, our DPO, or a copy of our DPA."],
];
  ...
  return (
    <div style={{ fontFamily: "-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif", color: COL.text, background: COL.bg, minHeight: "100dvh" }}>
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px 64px" }}>
        <div style={{ fontSize: 11, letterSpacing: ".18em", textTransform: "uppercase", color: COL.dim, marginBottom: 6 }}>Feynman Education</div>
